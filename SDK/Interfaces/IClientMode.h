...
#include "../Includes/VGUI.h"
#include "../Includes/ButtonCode.h"
...
public:
	...
	virtual void OverrideView(CViewSetup* pSetup) = 0; // Index 16
...
// ClientModeShared interface
class CClientModeShared : public IClientMode
{
public:
	// OverrideView is at vtable index 16
};

namespace I { inline CClientModeShared* ClientModeShared = nullptr; }
